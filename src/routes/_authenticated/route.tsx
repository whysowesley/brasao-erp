    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-background">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-20 flex h-12 sm:h-14 items-center gap-2 sm:gap-3 border-b bg-card/95 px-2.5 sm:px-4 backdrop-blur">
          ...
          <main className="flex-1 px-2.5 py-3 sm:px-6 sm:py-6 md:px-8">
            <Outlet />
          </main>
        </div>
      </div>
