...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,300..800;1,300..800&family=JetBrains+Mono:ital,wght@0,400..700;1,400..700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
      },
      { rel: "icon", href: "/brasao-logo.jpeg", type: "image/jpeg" },
      { rel: "apple-touch-icon", href: "/brasao-logo.jpeg" },
      { rel: "shortcut icon", href: "/brasao-logo.jpeg" },
    ],
  }),
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                try {
                  var saved = localStorage.getItem('brasao-theme') || 'system';
